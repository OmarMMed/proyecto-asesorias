...
<input class="Field" type="text" placeholder="Usuario" />
</div>  
<div class="inputContainer">
...
<input class="Field" type="password" placeholder="Contraseña" />
  ...
  <input type="checkbox" value="lsRememberMe" id="rememberMe"> <label for="rememberMe">Recordarme</label>   <a href="url"><br>Registrarme como RT </a><br><br>
